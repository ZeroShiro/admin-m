<template>
  <div class="manage">
    <el-dialog :title="operateType === 'add' ? '新增用户' : '更新用户'" :visible.sync="isDialog" :append-to-body="true" center width="560px">
      <user-form ref="resform" :formLabel="operateFormLabel" :form="operateForm" :isConfig.sync="isConfig"></user-form>
