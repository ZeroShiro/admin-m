<template>
  <div class="login">
    <div class="login-box">
      <el-form :model="login" ref="login" label-width="100px" class="demo-ruleForm">
        <h4>系统登陆</h4>
        <el-input
          type="text"
          size="large"
        ...
        <el-input
          ...
          placeholder="请输入密码"
        ></el-input>
        <el-button class="login-btn" type="primary" @click="submitForm('login')" @keyup.enter="submitForm('login')">提交</el-button>
