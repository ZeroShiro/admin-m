<template>
  <div class="home">
    ...
    <el-row :gutter="20">
      <el-col :xs="12" :sm="12" :lg="4" class="num" v-for="item in DataList" :key="item.id">
        <el-card shadow="hover" :body-style="{ padding: 0 }">
          <div class="detail">
            <i :class="`el-icon-${item.icon}`" :style="`color:${item.color};`"></i>
    ...
    <el-row :gutter="20">
      <user-info :img="img" :tableList="tableList" :tableLable="tableLable"></user-info>
      <el-col :xs="24" :sm="24" :lg="18" class="home-right">
        <el-row class="chart-box-l" :gutter="20">
          <el-col :xs="24" :sm="24" :lg="12">
            <el-card>
              <Echart class="box" :chartData="echartsData.shop" :isAxisChart="false"></Echart>
            </el-card>
          </el-col>
          <el-col :xs="24" :sm="24" :lg="12">
            <el-card>
